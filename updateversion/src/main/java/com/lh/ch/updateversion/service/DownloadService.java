package com.lh.ch.updateversion.service;
...
import com.lh.ch.updateversion.R;
import com.lh.ch.updateversion.UpdateHelper;
import com.lh.ch.updateversion.utils.FileUtil;
...
//                createThread();
//            } else {
//                Toast.makeText(DownloadService.this, "下载失败1", Toast.LENGTH_SHORT).show();
//                /***************stop service************/
//                stopSelf();
//            }
    ...
    public static void install(Context context) {
        ...
        Uri apkUri =
                FileProvider.getUriForFile(context, "com.lh.ch.hefenglocation.fileprovider", file);
            ...
            switch (msg.what) {
                case DOWN_SUCCESS:
                    ...
                    if (auto_Install) {
                        ...
                        if (Build.VERSION.SDK_INT >= 24) {
                            Uri apkUri = FileProvider.getUriForFile(DownloadService.this, "com.lh.ch.hefenglocation.fileprovider", updateFile);
                            intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                            intent.setDataAndType(apkUri, "application/vnd.android.package-archive");
                        } else {
