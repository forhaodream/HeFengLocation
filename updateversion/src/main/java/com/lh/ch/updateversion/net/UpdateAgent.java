package com.lh.ch.updateversion.net;
...
import com.lh.ch.updateversion.listener.NetCallBack;
import com.lh.ch.updateversion.service.DownloadService;
...
public class UpdateAgent {
    ...
    private void showAlertDialog(final Activity activity, final UpdateEntity updateEntity) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        builder.setTitle("软件升级 " + updateEntity.getVersionName());
